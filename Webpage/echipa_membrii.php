...
$q="SELECT Nume, Prenume, Functie FROM membrii_echipa m INNER JOIN functie_membru f ON m.IDFunctie=f.IDFunctie JOIN echipa e ON m.IDEchipa=e.IDEchipa
 WHERE m.IDEchipa LIKE '$id'
";
$r= mysql_query($q);
$rows = array();
