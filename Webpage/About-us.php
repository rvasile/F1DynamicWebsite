    ...
    <body>
        <div id="wrapper">
            <div id="header-wrapper">
                ...
                <div id="menu" class="container">
                    <ul>
                        ...
                        <li><a href="circuit_etapa.php" accesskey="5" title="">Masini</a></li>
            ...
            <div id="page" class="container">
                <p>Creator al acestei pagini: <strong>Razvan Vasile</strong></p>
                <p>Facultatea de <strong>Automatica si Calculatoare</strong></p>
                <p>Universitatea <strong>Politehnica Bucuresti</strong></p>
                <p>Sectia <strong>Ingineria Sistemelor Automate</strong></p>
                <p>Proiect realizat pentru materia <strong>Baze de Date</strong></p>
            </div>
