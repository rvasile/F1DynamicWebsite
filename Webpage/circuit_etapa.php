...
$q="SELECT Nume,Locatie,image, Nume_etapa,Data_etapa FROM etapa e INNER JOIN circuit c ON e.IDCircuit=c.IDCircuit ORDER BY e.Data_etapa ASC
";
$r= mysql_query($q);
$rows = array();
        ...
        <div id="wrapper">
          ...
          <div class="datagrid2">
                ...
                <table>
                    <thead>
                        <tr>
                            <th><strong>Numele Circuitului:</strong></th>
                            <th><strong>Locatie:</strong></th>
                             <th><strong>Nume etapa:</strong></th>
                             <th width='100px'><strong>Data etapa:</strong></th>
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td>$v[Locatie]</td>
                            <td>$v[Nume_etapa]</td>
                            <td width = '66px'>$v[Data_etapa]</td>
                            <td><img src='$v[image]' width='64px' height='64px'></td>
