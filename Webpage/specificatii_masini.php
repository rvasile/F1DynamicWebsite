...
$q="SELECT Denumire,Valoare FROM arespecificatii a INNER JOIN specificatii s ON a.IDSpecificatie=s.IDSpecificatie JOIN masina m ON a.IDMasina = m.IDMasina WHERE a.IDMasina LIKE '$id' 
