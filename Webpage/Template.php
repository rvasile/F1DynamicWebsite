...
<link rel=”stylesheet” id=”font-awesome-css” href=”//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css” type=”text/css” media=”screen”>
    ...
    <body>
        ...
        <!--Meniul site-ului -->
                <div id="menu" class="container">
                    <ul>
                        ...
                        <li><a href="circuit_etapa.php" accesskey="5" title="">Etape</a></li>
        ...
        <!-- Aisarea continutului din baza de date -->
            <div id="content_area" style="width: 800; margin:0 auto;">
                <?php echo $content; ?>
            </div>
    
        <!--Afisarea barei de statistici-->
    ...
    <!--Afisarea footer-ului site-ului-->
