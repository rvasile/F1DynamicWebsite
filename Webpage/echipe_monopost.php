...
$q="SELECT Denumire_masina, Model, Poza FROM masina m INNER JOIN echipa e ON m.IDEchipa= e.IDEchipa WHERE m.IDEchipa LIKE '$id'
";
$r= mysql_query($q);
$rows = array();
          ...
          <div class="datagrid2">
                ...
                <table>
                    ...
                    <?php
                        ...
                        echo"
                        <tr>
                            <td>$v[Denumire_masina] $v[Model]</td>
                            <td><img src='$v[Poza]' width='64px' height='64px'></td>
