...
$q="SELECT Prenume,Nume,Denumire,Functie FROM membrii_echipa me INNER JOIN functie_membru f ON me.IDFunctie=f.IDFunctie JOIN echipa e ON me.IDEchipa = e.IDEchipa ORDER BY me.IDEchipa
...
<!-- query bun :SELECT Prenume,Nume,Denumire,Functie FROM membrii_echipa me INNER JOIN functie_membru f ON me.IDFunctie=f.IDFunctie JOIN echipa e ON me.IDEchipa = e.IDEchipa WHERE me.IDEchipa = 3
Nu imi afisaza membrii echipei selectate in site, insa imi afisaza in MYSQL Queries  -->
		...
		<div class="column3">
            ...
            <div class="column4">
				<div class="box">
					...
					<p>Vezi aici cele mai jos cele mai noi stiri din Formula 1</p>
					<a href="https://www.formula1.com/content/fom-website/en/latest.html" class="button">Formula 1 Official</a> </div>
			</div>
