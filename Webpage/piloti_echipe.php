...
$q="SELECT Nume, Prenume, Nationalitate, Numar, Puncte_general, Podiumuri,imagine FROM pilot p INNER JOIN echipa e ON p.IDEchipa=e.IDEchipa  WHERE p.IDEchipa LIKE '$id'
";
$r= mysql_query($q);
$rows = array();
                ...
                <table>
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td>$v[Podiumuri]</td>
                            <td><img src='$v[imagine]' width='64px' height='64px'></td>
