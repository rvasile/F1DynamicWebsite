...
$q="SELECT IDMasina,Poza,Denumire_masina,Model, Denumire FROM masina m INNER JOIN echipa e where m.IDEchipa=e.IDEchipa ORDER BY m.Denumire_masina ASC";
$r= mysql_query($q);
$rows = array();
            ...
            <div class="datagrid2">
                ...
                <table>
                    ...
                    <?php
                        ...
                        echo"
                        <tr>
                            <td><a href='specificatii_masini.php?id=$v[IDMasina]'>$v[Denumire_masina]</a></td>
                            <td>$v[Model]</td>
                            <td>$v[Denumire]</td>
                            <td><img src ='$v[Poza]'></td>
