...
require 'Controller/PilotController.php';
$pilotController = new PilotController();

if(isset($_POST['names']))
    {
        //Fill page with circuits of the selected types;
        $pilotTables = $pilotController->CreatePilotTables($_POST['names']);
    }

 else {
      //Page is loaded for the first time, no type selected -> Fetch all types
        $pilotTables = $pilotController->CreatePilotTables('%');
      }

//Output page data
$title = 'Drivers';
$content = $pilotController->createPilotDropdownList(). $pilotTables;
...
<link rel=”stylesheet” id=”font-awesome-css” href=”//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css” type=”text/css” media=”screen”>
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="content_area" style="width: 800; margin:0 auto;">
                <table>
                <tr>
